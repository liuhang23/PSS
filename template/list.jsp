			...
			<div class="content-text">
				...
				<div class="square-o-top">
					<table width="100%" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td height="30">名称:</td>
							<td><s:textfield name="baseQuery.name" size="18" /></td>
							<td>xx名称:</td>
							<td>
							...
							<td width="136"><a href="${lowerDomain}_input.action"><img
							...
							<tr align="center" bgcolor="#FFFFFF">
								...
								<td><img src="images/icon_3.gif" /> <span
									style="line-height: 12px; text-align: center;"> <a
										class="xiu" href="#"
										onclick="updateDomain('${lowerDomain}',${id});">修改</a></span> <img
									src="images/icon_04.gif" /> <span
									style="line-height: 12px; text-align: center;"> <a
										class="xiu" href="#"
										onclick="deleteDomain(this,'${lowerDomain}_delete.action',${id});">删除</a></span></td>
							</tr>
						</s:iterator>
					</table>
				</div>
